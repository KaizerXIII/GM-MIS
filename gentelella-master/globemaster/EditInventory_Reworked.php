                            ...
                            <div class="x_title">
                                <h1>Edit Inventory - 
                                    <?php
                                     ...
                                     {
                                        $_SESSION['get_itemname_from_SOD'] = $_GET['item_name'];
                                        //Stores the Value of Get from View Inventory
                                        echo $_SESSION['get_itemname_from_SOD']; 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <!--  -->
                                                   ...
                                                   {       
                                                        ...
                                                        {
                                                            request = $.ajax({
                                                            url: "ajax/insert_and_update_restock_from_supplier.php",
                                                            type: "POST",
                                                            data: {
                                                                post_item_name: "<?php print_r($_SESSION['get_itemname_from_SOD']);?>",
                                                                post_restock_quantity: GET_RESTOCK_QTY
                                                            },
                                                                success: function(data, textStatus)
                                                                {
                                                                    alert(data);
                                                                    window.location.href = "EditInventory_Reworked.php";  
                                                                }//End Scucess                                                        
                                                            }); // End ajax   
...
<?php
    ...
    $skuArray = array();
    $itemNameArray = $_SESSION['get_itemname_from_SOD'];
    $itemTypeArray = array();
    ...
    $_SESSION['current_name'] = $itemNameArray;
    echo '<script>';
        ...
        echo 'itemNamefromHTML.value = itemNamefromPHP;';
