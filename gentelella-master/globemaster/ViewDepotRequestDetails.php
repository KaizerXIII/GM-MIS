    ...
    <div class="container body">
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                ...
                <div class="ln_solid"></div>
                <button name = "confirmButton" type="button" class="btn btn-primary"   data-toggle="modal" data-target=".bs-example-modal-md">Approve Request</button>
                <button type="button" class="btn btn-danger" onclick="cancelWarning()">Disapprove Request</button>
