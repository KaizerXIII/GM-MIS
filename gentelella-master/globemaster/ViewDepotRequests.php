                ...
                <div class="x_panel">
                  ...
                  <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    <ul id="myTab1" class="nav nav-tabs bar_tabs right" role="tablist">
                      ...
                      <li role="presentation" class=""><a href="#tab_content33" role="tab" id="profile-tabb3" data-toggle="tab" aria-controls="profile" aria-expanded="false"><font color = "green">Confirmed Requisitions</font></a>
                      </li>
                            ...
                            {                                                                   
                              echo '<tr>';
                                ...
                                {                                
                                  ...
                                  echo "<button class = 'btn btn-round btn-primary btn-xs' disabled>Requisition in Progress</button>";
                                  echo '</td>';
                                }
                      ...
                      <?php                            
                            ...
                            {                                                                   
                              echo '<tr>';
                                ...
                                {
                                  echo '<td align = "center">';
                                  echo "<button class = 'btn btn-round btn-info btn-xs' disabled>Requisition Approved</button>";
                                  echo '</td>';
                                }
                                else
                                {
                      ...
                      <?php                            
                            ...
                            {                                                                   
                              echo '<tr>';
                                ...
                                {
                                  echo '<td align = "center">';
                                  echo "<button class = 'btn btn-round btn-success btn-xs' disabled>Requisition Confirmed</button>";
                                  echo '</td>';
                                }
                      ...
                      <?php                            
                            ...
                            {                                                                   
                              echo '<tr>';
                                ...
                                {
                                  echo '<td align = "center">';
                                  echo "<button class = 'btn btn-round btn-danger btn-xs' disabled>Requisition Cancelled</button>";
                                  echo '</td>';
                                }
