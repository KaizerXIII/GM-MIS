                                ...
                                <form action="<?php echo $_SERVER['SalesForecasting.php']; ?>" method="POST" class="form-horizontal form-label-left">
                                    ...
                                    <div class="form-group" >
                                        <center>
                                            ...
                                            <div class='col-md-12'>
                                                <div class="form-group">
                                                    <input type="date" name="startdate" id = "startdate" onchange ="date_setter(this)" class="form-control col-md-7 col-xs-12 deliveryDate" min="<?php echo date("Y-m-d", strtotime("+1days")); ?>">
                                                </div>
                                            </div>
...
<script>
    function SHOW_FORECAST()
    {
        ...
        else
        {
            ...
            {
                window.location.href = "InventoryForecasting.php?item_id="+SET_ITEM_NAME+"&sd="+SET_START_DATE+"&ed="+SET_END_DATE+"&type="+TYPE;
            }
            else
            {
