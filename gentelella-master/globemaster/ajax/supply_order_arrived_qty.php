<?php
    ...
    $SQL_GET_ARRIVED_CURRENT_VALUE = "SELECT * FROM supply_order_details WHERE (supply_item_name = '$GET_ARRIVED_NAME') AND (supply_order_id = '$GET_ARRIVED_OR')";
    ...
    $SQL_UPDATE_SUPPLY_DETAILS = "UPDATE supply_order_details SET supply_arrived_quantity = '$UPDATE_ARRIVED_VALUE' WHERE (supply_item_name = '$GET_ARRIVED_NAME') AND (supply_order_id = '$GET_ARRIVED_OR')";
