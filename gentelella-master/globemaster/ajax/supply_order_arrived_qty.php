<?php
    ...
    $SQL_GET_ARRIVED_CURRENT_VALUE = "SELECT * FROM supply_order_details WHERE (supply_item_name = '$GET_ARRIVED_NAME') AND (supply_order_id = '$GET_ARRIVED_OR') AND (supplier_name = '$GET_SUPP_NAME')";
    ...
    $UPDATE_ARRIVED_VALUE = $GET_ARRIVED_QTY + $ROW_RESULT_GET_ARRIVED_CURRENT_VALUE['supply_arrived_quantity'];

    $SQL_UPDATE_SUPPLY_DETAILS = "UPDATE supply_order_details SET supply_arrived_quantity = '$UPDATE_ARRIVED_VALUE' WHERE (supply_item_name = '$GET_ARRIVED_NAME') AND (supply_order_id = '$GET_ARRIVED_OR')AND (supplier_name = '$GET_SUPP_NAME')";
